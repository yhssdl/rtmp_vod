...
$menu=array (
	...
	'live'=>array (
		'link'=>"admin_vod.php?action=main",
		0=>"直播",
		1=>"<a target='I2' href='admin_live.php?action=add'>预约录课</a>",
		2=>"<a target='I2' href='admin_live.php?action=list'>管理预约</a>",

		3=>"",
		4=>"<a target='I2' href='admin_vod.php?action=main'>查看直播</a>",
		5=>"<a target='I2' href='admin_vod.php?action=list'>管理直播</a>",
	),	
	'content'=>array (
		...
		4=>"<a target='I2' href='admin_jqtype.php'>课程分类</a>",
		5=>"",	
		...
		16=>"<a target='I2' href='admin_plus.php'>增强管理插件</a>",
		17=>"",	
	...
	'make'=>array (
		...
		2=>"",
		3=>"<a target='I2' href='admin_makehtml.php?action=baidu'>生成视频SiteMap</a>",
		4=>"<a target='I2' href='admin_makehtml.php?action=baidun'>生成新闻SiteMap</a>",
		5=>"<a target='I2' href='admin_makehtml.php?action=rss'>生成视频RSS</a>",
		6=>"<a target='I2' href='admin_makehtml.php?action=rssn'>生成新闻RSS</a>",
		7=>"<a target='I2' href='admin_makehtml.php?action=baidux'>生成视频百度站内</a>",
		8=>"<a target='I2' href='admin_makehtml.php?action=baiduxn'>生成新闻百度站内</a>",
	),
	'user'=>array (
	...
	'tool'=>array (
		...
		0=>"工具",
		1=>"<a target='I2' href='admin_datarelate.php?action=repeat'>视频数据检测</a>",
	...
	'system'=>array (
		...
		7=>"<a target='I2' href='../js/player/dmplayer/admin/'>弹幕播放插件</a>",
