...
button{padding:5px;outline: 0;border:1px solid #ccc; border-radius:2px;vertical-align:middle;background-color:#ccc;height: 28px;cursor: pointer;color:#333;}
								...
								<div class="chu" style="margin-top:2px">
									<div class="demoTable layui-form-item">
										<div class="layui-inline">
											...
											<button  style="background-color:#ccc;color:#000;height:35px; margin-top:1px;padding-left:10px;padding-right:10px;" lay-submit="search_submits" type="button" lay-filter="reloadlst_submit">搜索</button>
										</div>
									</div>
								</div>
...
<div class="bottom"><table width="100%" cellspacing="5"><tr><td align="center"><font style="color:#666;">本页面用时0.0123秒,共执行3次数据查询</font></td></tr><tr><td align="center"><a target="_blank" href="#"><font style="font-size:10px;color: #3F628C;line-height: 28px;">视频管理系统</font></a></td></tr></table></div>
</body>
